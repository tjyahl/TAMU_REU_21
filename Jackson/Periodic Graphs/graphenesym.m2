...
-- specialize edges to get a representation of graphene
...
degree SH --get 10, why? it makes it seem that this graph is different from the original graphene somehow.
factor SH_0
