...
clearAll
load "functions.m2"
denseData = AdjacentDensePeriodicMatrix(2,2); --returns matrix, ring with arbitrary edges, ideal identifying variables, and ring in same vars without edge variables, and system in ring with edges
